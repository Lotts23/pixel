...
private:
    ...
    float brushSizeValueStart = brushSizeValueSmall * scale;
...
/* 
Lägg in i handleEvents
            if (event.mouseButton.button == Mouse::Left) {
                FloatRect checkboxBounds = checkbox.getGlobalBounds();
                if (checkboxBounds.contains(mousePos)) {
                    outlineColorIsElementColor = !outlineColorIsElementColor; */
