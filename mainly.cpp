...
class DrawingApp {
public:
    DrawingApp(int initialSizeX = (128*8+20), int initialSizeY = (64*8+20)) : window(VideoMode(initialSizeX, initialSizeY), "Ritprogram"), numSquares(64), numSquaresTop(128), squareSize(8.0f), sizeX(initialSizeX - 20), sizeY(initialSizeY - 20) {
    initialize();
